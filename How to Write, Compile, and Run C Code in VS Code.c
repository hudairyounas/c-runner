...
void main()
{
    ...
    /*
        ...
        4. Open terminal and run this command to compile the main.c file "gcc main.c".
        5. You can see that there is another file that can be generated by compiler a.exe
        6. Now run a.exe file in terminal "./a.exe" and you see the output on the screen.
        7. Additional tip: if you are in VS code so you can install "code runner" extension. it can directly run your code in the output section. its advantage is you cannot need to write "gcc main.c" and a.exe
